...
while true; do
    case "$1" in
        -i|--image_size) IMAGE_SIZE=$2; shift 2;;
        -b|--batch_size) BATCH_SIZE=$2; shift 2;;
        -e|--epochs) EPOCHS=$2; shift 2;;
        -p|--patience) PATIENCE=$2; shift 2;;
        -d|--dataset_path) DATASET_PATH=$2; shift 2;;
        -v|--verbose_level) VERBOSE_LEVEL=$2; shift 2;;
        -t|--text_input_size) TEXT_INPUT_SIZE=$2; shift 2;;
