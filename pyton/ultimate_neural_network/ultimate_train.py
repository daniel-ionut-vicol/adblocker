...
os.mkdir(f'/models/model_{start_datetime}-{finish_datetime}')
plt.savefig(f'/models/model_{start_datetime}-{finish_datetime}/training_loss.png', bbox_inches='tight')
...
plt.legend(loc="upper left")
os.mkdir(f'/models/model_{start_datetime}-{finish_datetime}')
plt.savefig(f'/models/model_{start_datetime}-{finish_datetime}/training_accuracy.png', bbox_inches='tight')
