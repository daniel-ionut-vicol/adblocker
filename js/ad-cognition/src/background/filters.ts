...
export const DEFAULT_FILTERS: FilterInfo[] = [
    ...
    },
    {
        ...
        enabled: FILTER_RULESET[RulesetType.RULESET_225].enabled,
        iconId: IconId.AD_BLOCKING,
    ...
    },
    {
        ...
        enabled: FILTER_RULESET[RulesetType.RULESET_226].enabled,
        iconId: IconId.AD_BLOCKING,
        title: translator.getMessage('options_block_with_cnn_option'),
        description: translator.getMessage('block_with_cnn_option_desc'),
        groupId: FiltersGroupId.CUSTOM,
    },
    {
        id: FILTER_RULESET[RulesetType.RULESET_227].id,
        enabled: FILTER_RULESET[RulesetType.RULESET_227].enabled,
        iconId: IconId.AD_BLOCKING,
